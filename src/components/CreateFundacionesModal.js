...
function CreateFundacionesModal(props){

    const {show,handleClose} = props;

    const [idIdentificacion, setFundacionesId] = useState(null);
    const [nombreFundacion, setFundacionesNombre]= useState(null);
    const [proposito, setFundacionesProposito] = useState(null);
    const [direccion, setFundacionesDireccion] = useState(null);
    const [telefo, setFundacionesTelefo]=useState(null);
    ...
    return(
        ...
        <Modal.Header closeButton>
          <Modal.Title>Nueva Fundacion</Modal.Title>
        </Modal.Header>
        <Modal.Body>
            <Form>
                <FormGroup>
        ...
        <Modal.Footer>
          ...
          <Button 
            variant="primary" 
            onClick={() => props.handleSaveFundaciones({
              idIdentificacion,
              nombreFundacion,
              proposito,
              direccion,
...
export default CreateFundacionesModal;